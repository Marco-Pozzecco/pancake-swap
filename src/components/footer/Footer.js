            ...
            <section className="main-footer">
                <div>
                    ...
                    <ul className="menu-ul ">
                        ...
                        <li>
                            <a href="https://v2litepaper.pancakeswap.finance/">
                                Litepaper
                            </a>
                        </li>
                        <li>...</li>
                        <li>
                            <a href="https://pancakeswap.creator-spring.com/">
                                Online Store
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul className="menu-ul">
                        ...
                        <li>
                            <a href="https://docs.pancakeswap.finance/get-started">
                                Guides
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul className="menu-ul">
                        ...
                        <li>
                            <a href="https://docs.pancakeswap.finance/">
                                Documentation
                            </a>
                        </li>
                        <li>
            ...
            <section className="bottom-footer-2 flex2">
                ...
                <div className="flex2">
                    ...
                    <a href="/" className="link-aquagreen">
                        <button className="btn-footer button-aquagreen ">
                            Buy CAKE
                        </button>
                    </a>
                </div>
