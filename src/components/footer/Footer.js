        ...
        <div className="Container-Footer">
          <div className="Container-Footer-Firstbar">
            ...
            <div className="Container-Footer-Firstbar-Topbuttons">
              <div
                id="firstbar-right"
                className="Container-Footer-Latestbar-Right"
              >
                <div className="mobilefooter">
                  ...
                  <div id="firstbar-money" className="money">
                    $3.383
                  </div>
                </div>
              ...
              <div
                id="firstbar-left"
                className="Container-Footer-Latestbar-Left"
              >
                <div>
                  <ToggleTheme />
                </div>
          ...
          <div className="Container-Footer-Sub">
            <div className="Container-Footer-Main">
              <div className="Container-Footer-Main-Info">
                <div className="Container-Footer-Sub-Info">
                  <ul className="Container-Footer-Sub-Info-Ul">
                    ...
                    <li className="Container-Footer-Sub-Info-Ul-Li">
                      <a
                        href="/"
                        className="Container-Footer-Sub-Info-Ul-Li-Contact"
                        >
                        Contact
                      </a>
                    </li>
                    <li className="Container-Footer-Sub-Info-Ul-Li">
                      <a href="/" className="Container-Footer-Sub-Info-Ul-Li-a">
                        Brand
                      </a>
                    </li>
                    <li className="Container-Footer-Sub-Info-Ul-Li">
                ...
                <div className="Container-Footer-Sub-Info">
                  <ul className="Container-Footer-Sub-Info-Ul">
                    <li className="Container-Footer-Sub-Info-Ul-Titles">
                      DEVELOPERS
                    </li>
                    <li className="Container-Footer-Sub-Info-Ul-Li">
                      <a href="/" className="Container-Footer-Sub-Info-Ul-Li-a">
              ...
              <div className="Container-Footer-Icons">
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Twitter"
                  src={Twitter}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Telegram"
                  src={Telegram}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Reddit"
                  src={Reddit}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Instagram"
                  src={Instagram}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-GitHub"
                  src={github}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Discord"
                  src={discord}
                  alt=""
                />
                <img
                  className="Container-Footer-Icons-All"
                  id="Container-Footer-Icons-Medium"
                  src={Medium}
                  alt=""
                />
              </div>
