  ...
  return (
    <footer className="footer-box">
        <section className="main-footer">
            <div>
                ...
                <ul className="menu-ul ">
                    ...
                    <li><a href="https://medium.com/pancakeswap">Blog</a></li>
                    <li><a href="https://docs.pancakeswap.finance/contact-us/telegram">Community</a></li>
                    <li><a href="https://v2litepaper.pancakeswap.finance/">Litepaper</a></li>
                    <li>...</li>
                    <li><a href="https://pancakeswap.creator-spring.com/">Online Store</a></li>
                </ul>
            </div>
            <div>
                <h4>Help</h4>
                <ul className="menu-ul">
                    <li><a href="https://docs.pancakeswap.finance/contact-us/customer-support">Customer Support</a></li>
                    <li><a href="https://docs.pancakeswap.finance/help/troubleshooting">Troubleshooting</a></li>
                    <li><a href="https://docs.pancakeswap.finance/get-started">Guides</a></li>
                </ul>
            </div>
            <div>
                <h4>Developers</h4>
        ...
        <section className="bottom-footer">
            {/* <ul className="menu-ul">
                <li className="cursor"><i style="font-size: 1.2rem;" className="fa-brands fa-twitter"></i></li>
                <li className="cursor"><i style="font-size: 1.2rem;" className="fa-brands fa-instagram"></i></li>
                <li className="cursor"><i style="font-size: 1.2rem;" className="fa-brands fa-github"></i></li>
                <li className="cursor"><i style="font-size: 1.2rem;" className="fa-brands fa-reddit"></i></li>
                <li className="cursor"><i style="font-size: 1.2rem;" className="fa-solid fa-paper-plane"></i></li>
        ...
        <section className="bottom-footer-2 flex2">
            <div className="flex2">
               <div>
                ...
                <div className="flex2">
                <img className="fa-svg-icon" src={globeSvg} alt="globe icon"></img>
                    <p>EN</p>
            ...
            <div className="flex2">
                <svg viewBox="0 0 96 96" id="hover" width="48px" color="text" xmlns="http://www.w3.org/2000/svg" className="sc-8a800401-0 igZcUN"><circle cx="48" cy="48" r="48" fill="url(#paint0_linear_10493)">
