...
export function Core() {
    ...
    return <Button type="onlyBorderButton-purple" text="Core" svg={
        <svg viewBox="0 0 24 24" width="18px" color="secondary" xmlns="http://www.w3.org/2000/svg" class="sc-4ba21b47-0 dRdpmE">
