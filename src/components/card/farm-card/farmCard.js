      ...
      <div className={`earn-card ${parseInt(props.idx) < 3 && "earn-card-border-animated"}`}>
        ...
        <div className="card-header">
          <div className="card-fi-img">
            <img className="token1" src="https://pancakeswap.finance/images/tokens/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c.png" alt="" />
            <img className="token2" src="https://pancakeswap.finance/images/tokens/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82.png" alt="" />
          </div>
        ...
        <div className="card-body">
          <div className="card-body-apr card-entry">
            ...
            {data.apr && <p className="apr-value">{data.apr}</p>}
          </div>
