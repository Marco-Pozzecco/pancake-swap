        ...
        <div className="card-body">
          ...
          <div className="card-body-earned-cake card-entry">
            <div className="cake-earned-area">
              <p className="cake-earned-paragraph"><span className="text-bold">CAKE</span> EARNED:</p>
          ...
          <div className="card-fi-stack">
            <p className="card-fi-stack-paragraph"><span className="text-bold">{data.financialInstrument} LP</span> STAKED</p>
            <ConnectWalletBtn type={"farmsconnectwallet"} />
          </div>
        </div>
        <div className="card-details"> <p className="DetailsFarm">{ShowDetails ? <span className="DetailsFarm">Details {arrowdown}</span> : <span className="DetailsFarm">Hide {arrowup}</span>}</p>
