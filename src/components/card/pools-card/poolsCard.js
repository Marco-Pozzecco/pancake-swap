...
export function PoolCard(props) {
  ...
  return (
    <>
      <div className={`earn-card ${parseInt(props.idx) < 1 && "earn-card-border-animated"}`}>
        ...
        <div className="card-details"> <p className="DetailsPool">{ShowDetails ? <span className="DetailsPool">Details {arrowdown}</span> : <span className="DetailsPool">Hide {arrowup}</span>}</p>
          <div className={DetailsStatus}>
            <div className="LiquidityPools">
              <p className="TotalLiquidity">Total Liquidity:</p>
              <p>{data.liquidity}</p>
            </div>
            <a className="PoolsLink" href="">Get CAKE-BNB LP {svglink}</a>
            <a className="PoolsLink" href="">View Contract {svglink}</a>
            <a className="PoolsLink" href="">See Pair Info {svglink}</a>
          </div>
        </div>
      </div>
    </>
