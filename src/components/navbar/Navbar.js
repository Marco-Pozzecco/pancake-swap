...
export function Navbar () {
    return(
            ...
            <ul className="menu-ul menu-nav">
                ...
                <li><a href="info.html">...</a>
                    <ul>
                        ...
                        <li className="line-dd"><a href="">Leaderboard</a></li>
                        <li><a href="">Blog</a><i className="fa-regular fa-arrow-right-from-bracket"></i></li>
                        <li><a href="">Docs</a><i className="fa-regular fa-arrow-right-from-bracket"></i></li>
                    </ul>
                </li>
            </ul>
        </div>
        <section className="flex">
            <div>
                <svg viewBox="0 0 96 96" width="24px" color="text" xmlns="http://www.w3.org/2000/svg" className="sc-8a800401-0 igZcUN"><circle cx="48" cy="48" r="48" fill="url(#paint0_linear_10493)">
            ...
            <div  id="overlay"></div>
            {/* <!-- modal popup--> */}
            <div><a href="" className="link-aquagreen">
