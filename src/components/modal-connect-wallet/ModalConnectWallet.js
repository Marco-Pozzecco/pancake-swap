                    ...
                    <div
                        ...
                        <section className="second-card">
                            ...
                            <h3
                                ...
                                Login using a wallet connectio
                            </h3>
                            <img
                                className={
                                    switchImg === 1
                            ...
                            <p
                                ...
                                A Web3 Wallet allows you to send and receive
                                crypto assets like bitcoin, BNB, ETH, NFTs and
                                much more.
                            </p>
                            <p
                                className={
                                ...
                                Instead of setting up new accounts and passwords
                                for every website, simply set up your wallet in
                                one go, and connect it to your favorite DApps.
                            </p>
                            <div className="toggle-box">
                                <div
                                    ...
                                    onClick={() => toggleImg(1)}></div>
                                <div
                                    className={
                                        switchImg === 2
                                            ? "toggle-btn-right active-toggle-right"
                                            : "toggle-btn-right"
                                    }
                                    onClick={() => toggleImg(2)}></div>
                            </div>
                            <button>Learn How To Connect</button>
                        </section>
                    </div>
