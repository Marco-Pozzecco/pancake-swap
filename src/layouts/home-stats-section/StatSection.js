    ...
    <div>
                ...
                <div class="wrapper-stat">
                    ...
                    <div class="card-dst">
                        ...
                        <div class="card-dist-svg">
                            <svg class="cdsvg-color3"  viewBox="0 0 24 24" color="failure" width="36px" xmlns="http://www.w3.org/2000/svg" ><path d="M5 7C5 6.44772 4.55228 6 4 6C3.44772 6 3 6.44772 3 7V18C3 19.1046 3.89543 20 5 20H20C20.5523 20 21 19.5523 21 19C21 18.4477 20.5523 18 20 18H5V7Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M19 17H7C6.44772 17 6 16.5523 6 16V12C6 11.4477 6.44772 11 7 11H10V10C10 9.44772 10.4477 9 11 9H14V7C14 6.44772 14.4477 6 15 6H19C19.5523 6 20 6.44772 20 7V16C20 16.5523 19.5523 17 19 17ZM16 8H18V15H16V8ZM12 15H14V11H12V15ZM10 13H8V15H10V13Z"></path></svg>
                        </div>

                        <div class="card-dist-title">
                            <h2 class="cdta">$4.1 billion</h2>
                            <h2 class="cdtb cdtb3">users</h2>

                            <div class="card-dist-last-text">Total Value Locked</div>
                        </div>
            ...
            <div class="svg-transition-color-box">
                    <svg class="svg-transition-color" viewBox="0 0 1660 48" preserveAspectRatio="none" color="text" width="20px" xmlns="http://www.w3.org/2000/svg" ><path d="M1660 48C1139.02 46.1887 336.256 15.2453 0 0H1660V48Z"></path></svg>
            </div>
