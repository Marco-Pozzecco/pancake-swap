    ...
    <div className="wrapper-stat">
        ...
        <StatsSectionCard />
            ...
            {/* <div className="card-dst">
                <div className="card-dist-svg">
                    <svg
                        ...
                        <path
                            d="M2.81293 7.78034C3.10583 8.07323 3.5807 8.07323 3.87359 7.78034L6.48235 5.17158L6.48235 6.89645C6.48235 7.31067 6.81814 7.64645 7.23235 7.64645C7.64656 7.64645 7.98235 7.31067 7.98235 6.89645L7.98235 3.36092C7.98235 3.16201 7.90333 2.97124 7.76268 2.83059C7.62203 2.68994 7.43126 2.61092 7.23235 2.61092L3.69682 2.61092C3.2826 2.61092 2.94682 2.9467 2.94682 3.36092C2.94682 3.77513 3.2826 4.11092 3.69682 4.11092H5.42169L2.81293 6.71968C2.52004 7.01257 2.52004 7.48744 2.81293 7.78034Z"></path>
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                ...
                <div className="card-dist-title">
                    <h2 className="cdta">26 million</h2>
                    <h2 className="cdtb cdtb2">users</h2>
            ...
            {/* <div className="card-dst">
                <div className="card-dist-svg">
                    <svg
                        className="cdsvg-color3"
                        viewBox="0 0 24 24"
                        color="failure"
                        width="36px"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M5 7C5 6.44772 4.55228 6 4 6C3.44772 6 3 6.44772 3 7V18C3 19.1046 3.89543 20 5 20H20C20.5523 20 21 19.5523 21 19C21 18.4477 20.5523 18 20 18H5V7Z"></path>
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M19 17H7C6.44772 17 6 16.5523 6 16V12C6 11.4477 6.44772 11 7 11H10V10C10 9.44772 10.4477 9 11 9H14V7C14 6.44772 14.4477 6 15 6H19C19.5523 6 20 6.44772 20 7V16C20 16.5523 19.5523 17 19 17ZM16 8H18V15H16V8ZM12 15H14V11H12V15ZM10 13H8V15H10V13Z"></path>
                    </svg>
                </div>

                <div className="card-dist-title">
                    <h2 className="cdta">$4.1 billion</h2>
                    <h2 className="cdtb cdtb3">users</h2>
