    ...
    <>
        ...
        <div className="FarmssubContainer">
          ...
          <div className="FarmsContainer2">
            <div className="FarmsSubcontainer1">
              ...
              <p className="YieldParagraph2">
                An active fixed-term CAKE staking position is required for
                activating farm yield boosters
              </p>
      ...
      <div className="FarmsFilters">
        <div className="FarmsSubFilters">
          <button
            onClick={fcclickHandle}
            className="FarmsCardView"
            style={{ fill: fillfcc }}
          >
            <svg
              viewBox="0 0 24 24"
          ...
          <button
            onClick={ftclickHandle}
            className="FarmsTableView"
            style={{ fill: fillftc }}
          >
            <svg
              viewBox="0 0 24 24"
