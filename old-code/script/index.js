...
document.addEventListener(
    "DOMContentLoaded",
    changePredictionValueAtRandomInterval
);
document.addEventListener(
    "DOMContentLoaded",
    changeLotteryValueAtRandomInterval
);
...
function randomCirculatingSupply() {
    ...
    // Addizione o sottrazione casuale
    if (Math.random() >= 0.49) {
        circulatingSupply.textContent = (value + amount).toLocaleString(
            "en-US"
        );
    } else {
        circulatingSupply.textContent = (value - amount).toLocaleString(
...
document.addEventListener(
    "DOMContentLoaded",
    changeCirculatingSupplyAtRandomInterval
);
document.addEventListener(
    "DOMContentLoaded",
    changeTotalSupplyAtRandomInterval
);
